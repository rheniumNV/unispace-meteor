...
const detail = {
  code: "NexusUix/UserDateTimeText",
  propsConfig: {
    unixTime: UnitProp.Long(0),
    format: UnitProp.String("{0:F}"), // https://learn.microsoft.com/ja-jp/dotnet/standard/base-types/standard-date-and-time-format-strings
