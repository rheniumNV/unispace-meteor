...
export const O = (
  ...
  > & {
    ...
    styledHoverSprite?: StyledSpriteVariable;
    styledHoverMaterial?: StyledMaterialVariable;
  ...
  return Unit({
    ...
    styledHoverSprite: props.styledHoverSprite?.variableName,
    styledHoverMaterial: props.styledHoverMaterial?.variableName,
